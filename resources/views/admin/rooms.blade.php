        ...
        <div class="content">
            <div class="container-fluid">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="{{route('admin_rooms')}}">Rooms</a></li>
                  <li><a href="{{route('admin_rooms_bedspacer')}}">Bed Space</a></li>
                </ul>
                ...
                <div class="row">
                            ...
                            <tbody>
                                @foreach($rooms as $room)
                                    <tr>
                                        ...
                                        <td>{{$room->price}}</td>
                                        <td>
                                            <button class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal" value="{{$room->id}}">Edit</button>
                                        </td>    
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="col-md-4">
                        <h3>New Room</h3>
                        <form action="{{route('admin_rooms_check')}}" method="POST">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('admin_room_update')}}" method="POST">
