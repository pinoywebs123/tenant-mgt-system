        ...
        <div class="content">
            <div class="container-fluid">
             <ul class="nav nav-tabs">
              <li ><a href="{{route('admin_reports')}}">Rooms</a></li>
              <li class="active"><a href="{{route('admin_reports_bedspace')}}">Bed Space</a></li>
            </ul>
                        ...
                        <tbody>
                            @foreach($bedspacers as $tenant)
                              <tr>
                                  ...
                                  <td>{{$tenant->bedspacer->room_number}}</td>
